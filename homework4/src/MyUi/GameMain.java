...
/**
 * Main class for a GUI for a Tetris-type game sets up a GamePanel instance in a
 * frame. Edit the create() method to change the game or generator type.
 */
...
//		Game game = new hw4.BlockAddiction(8, 10, new BasicGenerator(rand));
